                ...
                <div class="container">
                    <div class="ht-left">
                        <div class="mail-service">
                            <i class=" fa fa-envelope"></i> gamagita.id@gmail.com
                        </div>
                        <div class="phone-service">
                            <i class=" fa fa-phone"></i> +62851 5646 5903
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="inner-header">
                    <div class="row">
                        <div class="col-lg-2 col-md-2">
                            <div class="logo">
                                <router-link to="/">
                                    <img src="img/logo_gamagita.png" height="70px" alt="" />
                                </router-link>
                            </div>
                        </div>
                                ...
                                <li class="cart-icon">
                                    ...
                                    <div class="cart-hover">
                                        ...
                                        <div class="select-button">
                                            <router-link to="/shoppingcart" class="primary-btn view-card">
                                                <a style="color: white" href="">VIEW CARD</a>
                                            </router-link>
